...
sudo tee "$DOCUMENT_ROOT/index.html" > /dev/null <<EOF
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Prueba de Balanceo de Carga - clienteWeb2</title>
    <style>
        body {
...
<body>
    ...
    <p>Esta página fue generada por el servidor: <strong>clienteWeb2</strong></p>
</body>
</html>
EOF

# Verificar si la creación del archivo HTML fue exitosa
if [ $? -ne 0 ]; then
    log_message "Error: Creación del archivo HTML fallida. Revisar el archivo de registro."
    exit 1
fi
