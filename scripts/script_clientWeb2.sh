...
LOG_FILE="/var/log/script_clienteWeb2.log"
...
if [ ! -f "$INDEX_FILE" ]; then
    ...
    <head>
        ...
        <title>Prueba de Balanceo de Carga - clientWeb2</title>
        <style>
            body {
    ...
    <body>
        ...
        <p>Esta página fue generada por el servidor: <strong>clientWeb2</strong></p>
    </body>
    </html>
    '
